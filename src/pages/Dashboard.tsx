...
export function Dashboard() {
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in duration-300 pb-12">
      ...
      <div className="bg-surface-900 border border-surface-800 text-white rounded-3xl p-6 sm:p-8 shadow-xl relative overflow-hidden">
      ...
      {selectedIncident && (
        <div className="bg-red-950/80 border-2 border-red-500/50 rounded-3xl p-6 text-white shadow-2xl space-y-6 animate-in slide-in-from-top duration-300">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-red-800/60 pb-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-red-600 text-white flex items-center justify-center font-bold shadow-lg animate-pulse">
      ...
      <div className="bg-gradient-to-br from-red-600 via-red-700 to-red-900 text-white rounded-3xl p-6 sm:p-10 shadow-2xl relative overflow-hidden flex flex-col items-center text-center space-y-6">
        ...
        <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full bg-white/10 text-white flex items-center justify-center ring-8 ring-white/20 shadow-2xl">
          <ShieldAlert className="w-10 h-10 sm:w-12 sm:h-12 animate-pulse text-white" />
        </div>

        <div className="space-y-2 max-w-lg">
          <h2 className="text-xs sm:text-sm font-black uppercase tracking-widest text-red-200">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
        ...
        <div className="bg-surface-900/90 border border-surface-800 hover:border-amber-500/50 rounded-3xl p-6 transition-all duration-200 space-y-4 flex flex-col justify-between group shadow-lg">
          <div className="space-y-3">
          ...
          <Link
            to="/report"
            className="inline-flex items-center justify-between px-5 py-3 rounded-xl bg-surface-800 hover:bg-amber-500 hover:text-black text-amber-400 font-bold text-sm transition-all duration-200 min-h-[44px]"
          >
        ...
        {/* Action 3: FIND HELP */}
        <div className="bg-surface-900/90 border border-surface-800 hover:border-blue-500/50 rounded-3xl p-6 transition-all duration-200 space-y-4 flex flex-col justify-between group shadow-lg">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
          ...
          <Link
            to="/map"
            className="inline-flex items-center justify-between px-5 py-3 rounded-xl bg-surface-800 hover:bg-blue-600 hover:text-white text-blue-400 font-bold text-sm transition-all duration-200 min-h-[44px]"
          >
        ...
        <div className="bg-surface-900/90 border border-surface-800 hover:border-emerald-500/50 rounded-3xl p-6 transition-all duration-200 space-y-4 flex flex-col justify-between group shadow-lg">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
          ...
          <Link
            to="/first-aid"
            className="inline-flex items-center justify-between px-5 py-3 rounded-xl bg-surface-800 hover:bg-emerald-600 hover:text-white text-emerald-400 font-bold text-sm transition-all duration-200 min-h-[44px]"
          >
        ...
        <div className="bg-surface-900/90 border border-surface-800 hover:border-purple-500/50 rounded-3xl p-6 transition-all duration-200 space-y-4 flex flex-col justify-between group shadow-lg">
          <div className="space-y-3">
            <div className="flex items-center justify-between">
          ...
          <Link
            to="/profile"
            className="inline-flex items-center justify-between px-5 py-3 rounded-xl bg-surface-800 hover:bg-purple-600 hover:text-white text-purple-400 font-bold text-sm transition-all duration-200 min-h-[44px]"
          >
      ...
      <div className="bg-surface-900/60 border border-surface-800/80 rounded-3xl p-6 space-y-4">
        <div className="flex items-center justify-between">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          <div className="p-4 rounded-2xl bg-surface-800/50 border border-surface-700/50 space-y-1">
