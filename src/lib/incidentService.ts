...
export function parseIncidentDoc(id: string, data: any): IncidentDoc {
  ...
  return {
    ...
    reporterUid: data.reporterUid || data.userId || "",
    reporterName: data.reporterName || data.userName || "Profile information unavailable",
...
export async function createEmergencyIncident(params: {
  ...
  const incidentData = {
    ...
    reporterName: params.reporterName || "Profile information unavailable",
